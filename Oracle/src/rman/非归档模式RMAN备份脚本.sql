rman target / nocatalog rman/rman@rman msglog '/backup/logs/itpux_fghsdb_rman_noarch_backup.log' << EOF
run {
...
backup
	incremental level 0
	skip inaccessible
	tag itpux_fghsdb_noarch
	filesperset 8 
	format '/backup/full/itpux_fghsdb_noarch_%s_%p_%t'
	(database);
release channel d1;
release channel d2;
