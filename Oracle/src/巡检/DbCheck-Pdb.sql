...
select  case WHEN to_number(regexp_substr(version,'[0-9].'))<12 then ' -- ' else '' end  IS_COMMENT from v$instance;

col  IS_UNCOMMENT new_value _UNCOMMENT noprint
select  case WHEN to_number(regexp_substr(version,'[0-9].'))<12 then '''non-supported''' else '--' end  IS_UNCOMMENT from v$instance;
...
<td nowrap><a class="link" href="#Temporary">Temporary Tablespace</a></td> -
<td nowrap><a class="link" href="#UNDO">UNDO Tablespace</a></td> -
</tr> 
...
<td nowrap><a class="link" href="#EVENT_ENABLED">Events</a></td> -
<td nowrap><a class="link" href="#exa">Exadata</a></td> -
</tr> -
...
<tr> -
<td nowrap><a class="link" href="#beginbck">Begin Backup Files</a></td> -
...
<td nowrap><a class="link" href="#audit">Audit</a></td> -
</tr>- 
<tr> -
...
<td nowrap><a class="link" href="#sysdba_user">SYSDBA Users</a></td> -
</tr>-
<tr> -
<td nowrap><a class="link" href="#TDE">Transparent Data Encryption</a></td> -
<td nowrap></td> -
<td nowrap></td> -
<td nowrap></td> -
</tr>-
...
<tr> -
<td nowrap><a class="link" href="#RAC">RAC overview</a></td> -
<td nowrap><a class="link" href="#pub_Network">Public_Network</a></td> -
<td nowrap><a class="link" href="#pri_Network">private_Network</a></td> -
...
<td nowrap><a class="link" href="#tg_load_profile">Last 3 days Load Profile</a></td> -
<td nowrap><a class="link" href="#iowait3">Last 3 days IO event</a></td> -
</tr>-
<tr> -
<td nowrap><a class="link" href="#SYSMETRIC_3">Last 24hour sysmetric</a></td> -
<td></td> -
<td></td> -
<td></td> -
</tr>-
...
prompt <tr><th colspan="4">New Features</th></tr> -
<tr> -
<td nowrap><a class="link" href="#long_identifiers">Long Identifiers</a></td> -
<td nowrap><a class="link" href="#max_str">Max String</a></td> -
<td nowrap><a class="link" href="#SAR"></a></td> -
<td nowrap><a class="link" href="#VMSTAT"></a></td> -
</tr> 
...
select 
&_COMMENT con_id,name,dbid,open_mode,open_time,floor(sysdate-cast(open_time as date))||'Days '||floor(((sysdate-cast(open_time as date))-floor(sysdate-cast(open_time as date)))*24)||'hours '||round(((sysdate-cast(open_time as date)-floor(sysdate-cast(open_time as date) )*24)-floor((sysdate-cast(open_time as date)-floor(sysdate-cast(open_time as date))*24)))*60)||'minutes' "Database Uptime" from v$containers
&_UNCOMMENT   from dual;
...
&_COMMENT       p1.con_id,
&_COMMENT       p1.name,
&_COMMENT       p1.open_mode,
&_COMMENT       p1.restricted,
&_COMMENT       p1.total_size,
&_COMMENT       p1.block_size,
&_COMMENT       p1.application_root ,
&_COMMENT       p1.application_pdb ,
&_COMMENT       p1.application_seed ,
&_COMMENT       p1.proxy_pdb,
&_COMMENT       p2.application_clone,
&_COMMENT       p2.refresh_mode,
&_COMMENT       p2.refresh_interval,
&_COMMENT       local_undo,
&_COMMENT       max_size
&_COMMENT  from v$pdbs p1, cdb_pdbs p2
&_COMMENT where p1.con_id = p2.con_id
&_UNCOMMENT   from dual;
...
prompt  Pluggable Database  Save States
 ...
 select 
&_COMMENT * from cdb_pdb_saved_states order by 1
&_UNCOMMENT   from dual;
...
col "00-01_ " for 990.9
col "01-02_ " for 990.9
col "02-03_ " for 990.9
col "03-04_ " for 990.9
col "04-05_ " for 990.9
col "05-06_ " for 990.9
col "06-07_ " for 990.9
col "07-08_ " for 990.9
col "08-09_ " for 990.9
col "09-10_ " for 990.9
col "10-11_ " for 990.9
col "11-12_ " for 990.9
col "12-13_ " for 990.9
col "13-14_ " for 990.9
col "14-15_ " for 990.9
col "15-16_ " for 990.9
col "16-17_ " for 990.9
col "17-18_ " for 990.9
col "18-19_ " for 990.9
col "19-20_ " for 990.9
col "20-21_ " for 990.9
col "21-22_ " for 990.9
col "22-23_ " for 990.9
col "23-24_ " for 990.9
...
,      ss.b_time
,      duration
,   round(MAX(CASE WHEN oss1.stat_name = 'LOAD' THEN oss1.value END),2) load 
,   round(MAX(CASE WHEN oss1.stat_name = 'NUM_CPUS' THEN oss1.value END),2) CPUS 
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'DB time' THEN em.value - bm.value END)/1000000,2),'9999990.9')        db_time
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'DB time' THEN em.value - bm.value END)/(ss.duration*1000000),1),'99990.99')        aas
,round(MAX(CASE WHEN sm.metric_name = 'Host CPU Utilization (%)' THEN round(sm.average,2) END),2) "cpu_util%" 
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'DB CPU' THEN em.value - bm.value END)/1000000,2),'99990.99')                                      db_cpu
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'background cpu time' THEN em.value - bm.value END)/1000000,2),'99990.99')  bg_cpu
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'RMAN cpu time (backup/restore)' THEN em.value - bm.value END)/1000000,2),'99990.99')              rman_cpu
,round(MAX(CASE WHEN sm.metric_name = 'Average Synchronous Single-Block Read Latency' THEN round(sm.average,2) END),2) io_speed  
,round(MAX(CASE WHEN sm.metric_name = 'User Transaction Per Sec' THEN round(sm.average,2) END),2) tps  
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'sql execute elapsed time' THEN em.value - bm.value END)/1000000,2),'99990.99')                    sql_time
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'PL/SQL execution elapsed time' THEN em.value - bm.value END)/1000000,2),'99990.99')               plsql_time
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'parse time elapsed' THEN em.value - bm.value END)/1000000,2),'99990.00')                          parse_time
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'failed parse elapsed time' THEN em.value - bm.value END)/1000000,2),'99990.99')                   failed_parse
,      TO_CHAR(ROUND(MAX(CASE WHEN bm.stat_name = 'connection management call elapsed time' THEN em.value - bm.value END)/1000000,2),'99990.99')     connectm
FROM  subq_snaps              ss
,     dba_hist_sys_time_model em
,     dba_hist_sys_time_model bm
,dba_hist_osstat oss1
...
and oss1.dbid=ss.dbid
and oss1.instance_number=ss.inst
and oss1.snap_id=ss.e_snap
and sm.dbid            = ss.dbid
...
host echo Check SYSMETRIC  Last 24 hour...
prompt <a name="SYSMETRIC_3"></a>.
col index_leaf_split_ps heading "indleaf|split ps"
col net_traff_ps heading "net_traff|ps"
col d for a20
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Last 24Hour Sysmetric </b></font>
--DBA_HIST_SYSMETRIC_HISTORY
with t as (select INSTANCE_NUMBER inst, to_char(begin_time,'yyyy-mm-dd hh24:mi') d,metric_name,round(avg(average)*count(distinct instance_number),3) average  from dba_hist_sysmetric_summary where 
begin_time>trunc(sysdate-1) and 
metric_name in (
...
group by INSTANCE_NUMBER,to_char(begin_time,'yyyy-mm-dd hh24:mi'),metric_name)
select * from t pivot (max(average) for metric_name in
 ...
 'Redo Generated Per Txn' as redo_ptx,
 'DB Block Changes Per Sec' as block_chan_ps,
 'DB Block Changes Per Txn' as block_chan_ptx,
 'Executions Per Sec' as execs_ps,
 'Executions Per Txn' as execs_ptx,
 'User Calls Per Sec' as calls_ps,
 'Average Synchronous Single-Block Read Latency' as IO_Latency,
 'I/O Megabytes per Second' as iomb_ps,
...
'Network Traffic Volume Per Sec' as net_traff_ps
 )) order by 1,d;
...
SELECT 
&_COMMENT TO_CHAR(ACTION_TIME, 'DD-MON-YYYY HH24:MI:SS') AS ACTION_TIME, PATCH_TYPE,
&_COMMENT ACTION,STATUS,DESCRIPTION, SOURCE_VERSION,TARGET_VERSION, PATCH_ID FROM SYS.DBA_REGISTRY_SQLPATCH ORDER BY ACTION_TIME DESC
&_UNCOMMENT   from dual; 

SELECT 
&_COMMENT XMLTRANSFORM(DBMS_QOPATCH.GET_OPATCH_BUGS, DBMS_QOPATCH.GET_OPATCH_XSLT) "BUG FIXED PATCH IDS" FROM DUAL
&_UNCOMMENT   from dual; 

begin
&_COMMENT   DBMS_QOPATCH.GET_SQLPATCH_STATUS;
null;
end;
/
...
prompt
prompt
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Size Overview</b></font>
...
&_COMMENT       c.con_id,
&_COMMENT       c.name,
&_COMMENT	   b.tablespace_name,
&_COMMENT       b.contents,
&_COMMENT       b.status,
&_COMMENT--	   round(a.free_space/1024/1024,2)  free_space,
&_COMMENT       round(a.tablespace_size/1024/1024,2) tablespace_size,
&_COMMENT       round(a.allocated_space/1024/1024,2) allocated_space,
&_COMMENT       round(a.free_space/1024/1024,2) free_space,
&_COMMENT       b.extent_management,
&_COMMENT       b.segment_space_management
&_COMMENT  from cdb_temp_free_space a, cdb_tablespaces b, v$containers c
&_COMMENT where a.tablespace_name = b.tablespace_name
&_COMMENT   and a.con_id = b.con_id
&_COMMENT   and b.con_id = c.con_id
&_COMMENT   and b.contents = 'TEMPORARY'
&_COMMENT  order by 1
&_UNCOMMENT   from dual;
...
select t.tablespace_name, t.status tb,d.file_id df#, d.status dfstat,
...
select to_char(s.end_time,'yyyy-mm-dd hh24:mi:ss') end_time &_COMMENT, t.con_id
, s.inst_id, s.undotsn, t.name, sum(activeblks)
from gv$undostat s
join gv$tablespace t on t.ts# = s.undotsn
   and s.inst_id = t.inst_id
&_COMMENT   and s.con_id = t.con_id
where s.end_time = ( select max(end_time) from gv$undostat)
group by to_char(s.end_time,'yyyy-mm-dd hh24:mi:ss') &_COMMENT, t.con_id
, s.inst_id, s.undotsn, t.name
order by 1,2
/

col status format a20 head "Status"
col cnt format 999,999,999 head "How Many? ROLL SEGS"
...
select TABLESPACE_NAME,status,round(sum(bytes)/1024/1024/1024) size_gb from DBA_UNDO_EXTENTS group by TABLESPACE_NAME,status
/

host echo Check DB Fragmentation...
prompt <a name="Fragmentation"></a>
prompt <font size="+1" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b> DB Fragmentation</b></font>
prompt  Datafiles level
COL fsfi FOR 9999.99

select a.*,df.name from (
...
) a,v$datafile df where a.file_id=df.file#
order by     1,2;


select 
&_COMMENT    c.name container_name, a.*,df.name from (
&_COMMENT select     con_id,  
&_COMMENT    tablespace_name
&_COMMENT , file_id
&_COMMENT ,          sqrt(max(blocks)/sum(blocks)) *
&_COMMENT           (100/sqrt(sqrt(count(blocks)))) fsfi
&_COMMENT   from          cdb_free_space
&_COMMENT group by      con_id,
&_COMMENT tablespace_name, file_id
&_COMMENT ) a,v$datafile df,v$containers c where a.file_id=df.file# and a.con_id=c.con_id
&_COMMENT order by 1,2 
&_UNCOMMENT from dual;


prompt  Tablespaces level
 SELECT
 tablespace_name, 
 count(*) free_chunks,
 ...
 nvl(round(sqrt(max(blocks)/sum(blocks))*(100/sqrt(sqrt(count(blocks)) )),2),0) fsfi
 FROM
 sys.dba_free_space 
 group by 
 tablespace_name
 order by 2 desc, 1;
prompt Note:  FSFI should be greater than 40% is OK, If FSFI is lower than 30% means it have high free space fragmentation index. 
...
select 
	...
	decode(autoextensible, 'YES', dbms_xplan.FORMAT_SIZE(MAXBYTES), null)  max_size,decode(a.status,'AVAILABLE',a.status,'<div align="left"><font color="red">' || a.status || '</font></div>') STATUS
from
...
select 
&_COMMENT        b.con_id,
&_COMMENT        b.name container,
&_COMMENT        a.tablespace_name,
&_COMMENT        a.file_name,
&_COMMENT        a.bytes / 1024 / 1024 total_mb,
&_COMMENT        a.maxbytes / 1024 / 1024 max_mb,
&_COMMENT        a.autoextensible,
&_COMMENT        decode(a.online_status,'ONLINE',a.online_status,'SYSTEM',a.online_status,'<div align="left"><font color="red">' || a.online_status || '</font></div>') status
&_COMMENT   from cdb_data_files a, v$containers b
&_COMMENT  where a.con_id = b.con_id
&_COMMENT union all
&_COMMENT select b.con_id,
&_COMMENT        b.name container,
&_COMMENT        a.tablespace_name,
&_COMMENT        a.file_name,
&_COMMENT        a.bytes / 1024 / 1024 total_mb,
&_COMMENT        a.maxbytes / 1024 / 1024 max_mb,
&_COMMENT        a.autoextensible,
&_COMMENT        decode(a.status,'ONLINE',a.status,'<div align="left"><font color="red">' || a.status || '</font></div>') status
&_COMMENT   from cdb_temp_files a, v$containers b
&_COMMENT   where a.con_id = b.con_id
&_COMMENT order by 1,2,3
&_UNCOMMENT from dual;
...
select
&_COMMENT       a.con_id,
&_COMMENT       c.name container,
&_COMMENT       a.tablespace_name,
&_COMMENT       a.type,
&_COMMENT       space total_size,
&_COMMENT	   nvl(free_space, 0) free_size,
&_COMMENT    -- space - nvl(free_space, 0) used_mb,
&_COMMENT       case
&_COMMENT          when trunc ( (1 - nvl (free_space, 0) / space) * 100) >= 90
&_COMMENT          then '<div align="right"><font color="red">' || to_char (round ( (1 - nvl (free_space, 0) / space) * 100, 2), '990.99') || '</font></div>'
&_COMMENT          else '<div align="right">' || to_char (round ( (1 - nvl (free_space, 0) / space) * 100, 2), '990.99') || '</div>'
&_COMMENT       end used,
&_COMMENT	   a.bigfile,
&_COMMENT       decode(a.status,'ONLINE',a.status,'<div align="left"><font color="red">' || a.status || '</font></div>') status,
&_COMMENT       a.extent_management,
&_COMMENT       a.segment_space_management,
&_COMMENT	   extensible_mb extensible_size,
&_COMMENT       case
&_COMMENT          when trunc ( (1 - nvl (free_space + extensible_mb, 0) / space_e) * 100) >= 90
&_COMMENT          then '<div align="right"><font color="red">' || to_char (round ( (1 - nvl (free_space+extensible_mb, 0) / space_e) * 100, 2), '990.99') || '</font></div>'
&_COMMENT          else '<div align="right">' || to_char (round ( (1 - nvl (free_space+extensible_mb, 0) / space_e) * 100, 2), '990.99') || '</div>'
&_COMMENT       end e_used
&_COMMENT  from (select d.con_id,
&_COMMENT               d.tablespace_name,
&_COMMENT               t.contents type,
&_COMMENT               t.status,
&_COMMENT               t.bigfile,
&_COMMENT               t.extent_management,
&_COMMENT               t.segment_space_management,
&_COMMENT               round(sum(d.bytes) / 1024 / 1024, 2) space,
&_COMMENT               round(sum(to_number(decode(autoextensible, 'NO', to_char(d.bytes), 'YES', to_char(maxbytes)))) / 1024 / 1024, 2) space_e,
&_COMMENT               round(sum(to_number(decode(autoextensible, 'YES', to_char(maxbytes - bytes), '0'))) / 1024 / 1024, 2) extensible_mb
&_COMMENT          from cdb_data_files d, cdb_tablespaces t
&_COMMENT         where d.tablespace_name = t.tablespace_name
&_COMMENT		   and d.con_id = t.con_id
&_COMMENT         group by d.con_id,
&_COMMENT		          d.tablespace_name,
&_COMMENT                  t.contents,
&_COMMENT                  t.status,
&_COMMENT                  t.bigfile,
&_COMMENT                  t.extent_management,
&_COMMENT                  t.segment_space_management) a,
&_COMMENT       (select con_id, tablespace_name,
&_COMMENT               round(sum(bytes) / 1024 / 1024, 2) free_space
&_COMMENT          from cdb_free_space
&_COMMENT         group by con_id, tablespace_name) b,
&_COMMENT	   (select con_id, name from v$containers) c
&_COMMENT where a.tablespace_name = b.tablespace_name(+)
&_COMMENT   and a.con_id = b.con_id
&_COMMENT   and b.con_id = c.con_id
&_COMMENT order by con_id, used desc
&_UNCOMMENT from dual;
prompt <ul>-
...
case
when value >30 then 'Too longger!!!'
else
'This value is appropriate!'
END   CHK_RESULT
 from gv$parameter where name in('control_file_record_keep_time');
...
prompt <font size="+1" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Online Redo/Standby Redo Overview</b></font>
...
select thread#,status,count(*) cnt from v$log  group by thread#,status;
select group#, status, type, is_recovery_dest_file, member log_member from v$logfile order by group#,member;

prompt online log archive slow(long than 10minute) or hang
select thread#,sequence#,first_time,next_time,completion_time,(completion_time-next_time)*24*3600  arc_completed_use_time_sec
from v$archived_log 
where first_time>sysdate-7 and standby_dest='NO' 
and (completion_time-next_time)*24*60>10
...
prompt the private redo strands in shared_pool,_log_parallelism_max=CPUS/16. LOG_BUFFER/_log_parallelism_max should be > REDO_LOG_MB

select * from v$standby_log order by group#;
prompt Tip:
prompt The standby redo logs should be the same size as the online redo logs.
prompt There should be (( # of online logs per thread + 1) * # of threads) standby redo logs. for dataguard
...
host echo Check DB Registry and Option... 
prompt <a name="Option"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Registry  Option Overview</b></font>
...
prompt The time to respond LAST 1 minuts
...
prompt The time to respond LAST 1 hours
select inst_id,to_char(a.begin_time,'yyyymmdd hh24:mi:ss') btime, to_char(a.end_time,'yyyymmdd hh24:mi:ss') etime,INTSIZE_CSEC,METRIC_NAME,NUM_INTERVAL,MAXVAL,AVERAGE,METRIC_UNIT from gv$sysmetric_summary a  where metric_name like 'SQL Service Response%';

prompt
prompt IO Throughput LAST 1 minuts
clear columns
select * from gv$sysmetric  where metric_name like '%Reads Per Sec%';

prompt IO Throughput LAST 1 hours
select inst_id,to_char(a.begin_time,'yyyymmdd hh24:mi:ss') btime, to_char(a.end_time,'yyyymmdd hh24:mi:ss') etime,INTSIZE_CSEC,METRIC_NAME,NUM_INTERVAL,MAXVAL,AVERAGE,METRIC_UNIT from gv$sysmetric_summary a  where metric_name like 'I/O%';


prompt
prompt Sysmetric LAST 1 minuts
...
prompt
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Last 3 days for Enqueue Events</b></font>	

select /*+rule*/ instance_number,
             end_interval_time,
             snap_id,
             event_name,
       ...
       where rank <> 1 and wait_time>600 and waits>60 and round(wait_time / 1e3 / decode(waits, 0, null, waits), 2)>1
       order by 1, 2, 4;
...
prompt Revealing the CBC Latch to Buffer Ratio
...
prompt Identifying Segments with High CBC Latch Sleeps   
...
select inst_id,name,type ptype,DISPLAY_VALUE,ISDEFAULT,DESCRIPTION  from  gV$SYSTEM_PARAMETER where ISDEFAULT='FALSE' order by 1,2;
...
SELECT
  ...
  , (CASE s.activation_level
         WHEN 'TYPICAL' THEN  s.activation_level 
         WHEN 'ALL'     THEN  s.activation_level 
...
END IF;
if
 bufcac < 90  then dbms_output.put_line('*** HINT: Buffer Cache hit <90% too low! Increase the DB Block Buffer value.');
END IF;
if
...
show parameter shared_pool_reserved_
...
select
 ...
 where n.indx=c.indx
 and (
    ksppinm in('shared_pool_reserved_size','_shared_pool_reserved_min_alloc')
 );
...
prompt IF the failing size as indicated by the ORA-4031 error messages or LAST_FAILURE_SIZE column of V$SHARED_POOL_RESERVED  is bigger than
prompt _shared_pool_reserved_min_alloc that is an indication the Reserved area needs to be increased to accommodate these large space requests.else caused by shared_pool fragmentation
...
prompt <a name="PGA"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>PGA Overview</b></font>
 
column instance_name heading 'Instance'
column name          heading 'Name'
column pgastat_value     for 999,999,999,999,999,999    heading 'Value'
...
group by &_COMMENT con_id,
inst_id,username, program, server
order by count(*) desc
/
...
select bg.inst_id,p.pid,p.spid,bg.name,bg.DESCRIPTION,bg.error &_COMMENT,bg.priority 
from gv$bgprocess bg ,gv$process p 
where bg.inst_id=p.inst_id and  bg.paddr=p.addr order by 1,bg.name &_COMMENT,bg.priority;
...
select 'LMS', INST_ID
&_COMMENT ,PRIORITY
,COUNT(*) TOTAL FROM GV$BGPROCESS where name like 'LMS%'
 GROUP BY INST_ID  &_COMMENT ,PRIORITY ;
...
prompt <font size="+1" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Last 3 days Load Profile overview</b></font>

host echo Check last 3 days load profile ...
...
select
  ...
  from (select 
         ...
         where e.instance_number = s.instance_number
           and e.dbid = s.dbid
           and s.end_interval_time > trunc(sysdate - 3)
           and e.snap_id = s.snap_id
           and e.stat_name in
               ('db block changes',
                'execute count',
...
select 
&_COMMENT       container,
&_COMMENT       instance_number,
&_COMMENT       end_interval_time,
&_COMMENT       snap_id,
&_COMMENT       sum(decode(stat_name, 'db block changes', value, 0)) as "db block changes",
&_COMMENT       sum(decode(stat_name, 'execute count', value, 0)) as "execute count",
&_COMMENT       sum(decode(stat_name, 'logons cumulative', value, 0)) as "logons cumulative",
&_COMMENT       sum(decode(stat_name, 'parse count (total)', value, 0)) as "parse count (total)",
&_COMMENT       sum(decode(stat_name, 'parse count (hard)', value, 0)) as "parse count (hard)",
&_COMMENT       sum(decode(stat_name, 'parse time elapsed', value, 0)) as "parse time elapsed",
&_COMMENT       sum(decode(stat_name, 'physical reads', value, 0)) as "physical reads",
&_COMMENT       sum(decode(stat_name, 'physical writes', value, 0)) as "physical writes",
&_COMMENT       sum(decode(stat_name, 'redo size', value, 0)) as "redo size",
&_COMMENT       sum(decode(stat_name, 'session logical reads', value, 0)) as "session logical reads",
&_COMMENT       sum(decode(stat_name, 'user calls', value, 0)) as "user calls",
&_COMMENT       sum(decode(stat_name, 'user commits', value, 0)) as "user commits",
&_COMMENT       sum(decode(stat_name, 'user rollbacks', value, 0)) as "user rollbacks",
&_COMMENT       sum(decode(stat_name, 'workarea executions - optimal', value, 0)) as "SQL workarea"
&_COMMENT  from (select c.name container,
&_COMMENT               e.instance_number,
&_COMMENT               s.end_interval_time,
&_COMMENT               e.snap_id,
&_COMMENT               e.stat_name,
&_COMMENT               e.value - lag(e.value) over(partition by e.con_id, e.instance_number, s.startup_time, e.stat_name order by e.snap_id) value,
&_COMMENT               dense_rank() over(partition by e.con_id, s.startup_time, e.stat_name order by e.snap_id) rank
&_COMMENT          from cdb_hist_sysstat e, cdb_hist_snapshot s, v$containers c
&_COMMENT         where e.instance_number = s.instance_number
&_COMMENT           and e.dbid = s.dbid
&_COMMENT           and e.con_id = c.con_id
&_COMMENT           and s.end_interval_time > sysdate - 7
&_COMMENT           and e.snap_id = s.snap_id
&_COMMENT           and e.stat_name in
&_COMMENT               ('db block changes',
&_COMMENT                'execute count',
&_COMMENT                'logons cumulative',
&_COMMENT                'parse count (total)',
&_COMMENT                'parse count (hard)',
&_COMMENT                'parse time elapsed',
&_COMMENT                'physical reads',
&_COMMENT                'physical writes',
&_COMMENT                'redo size',
&_COMMENT                'session logical reads',
&_COMMENT                'user calls',
&_COMMENT                'user commits',
&_COMMENT                'user rollbacks',
&_COMMENT                'workarea executions - optimal'))
&_COMMENT where rank <> 1
&_COMMENT group by container, instance_number, end_interval_time, snap_id
&_COMMENT order by container, instance_number, snap_id
&_UNCOMMENT   from dual;
...
prompt  Indexes online building or rebuilding  ora-8104
select u.name owner,o.name index_name,o.obj#,i.flags from  sys.user$ u, sys.ind$ i, sys.obj$ o 
where u.user# = o.owner# and  o.obj# = i.obj# and  bitand(i.flags, 512) = 512; 
-- bitand(i.flags, 4096) = 0
--substr(to_char(i.flags,'xxxxxxxxx'),-3,1) in('1','2'); 
...
&_COMMENT       c.name container,
&_COMMENT       i.owner,
&_COMMENT       i.index_name,
&_COMMENT       i.index_type,
&_COMMENT       i.table_name,
&_COMMENT       i.status
&_COMMENT  from cdb_indexes i, v$containers c
&_COMMENT where status = 'UNUSABLE'
&_COMMENT   and i.con_id = c.con_id
&_UNCOMMENT   from dual;
...
host echo Check indexes with blevel more than 3 or degree large than 1 ...

select 
&_COMMENT c.name container,i.owner index_owner,i.index_name,i.index_type,i.table_owner,i.table_name,i.uniqueness,i.compression,i.blevel,i.degree
&_COMMENT from cdb_indexes i, v$containers c
&_COMMENT where i.con_id = c.con_id
&_COMMENT and (blevel > 3 or degree not in ('0','1','DEFAULT'))
&_COMMENT order by 1,2,3
&_UNCOMMENT   from dual;

select  i.owner index_owner,i.index_name,i.index_type,i.table_owner,i.table_name,i.uniqueness,i.compression,i.blevel,i.degree
from dba_indexes i 
where  (blevel > 3 or degree not in ('0','1','DEFAULT'))
order by 1,2,3;

prompt
prompt Tables  Object-level parallelism
...
select 
&_COMMENT pdb_name,OWNER,TYPE,count(*) from cdb_recyclebin bin,dba_pdbs pdb where bin.con_id=pdb.con_id group by pdb_name, owner,type order by 4
&_UNCOMMENT   from dual;
 prompt
...
prompt <a name="TDE"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>TDE</b></font>
 
prompt What tables contain TDE encrypted columns?
select * from  DBA_ENCRYPTED_COLUMNS;

prompt What tablespaces use TDE?
select t.name,et.* from V$ENCRYPTED_TABLESPACES et,v$tablespace t where et.ts#=t.ts#;

prompt What tables are stored in TDE encrypted tablespaces?
select a.table_name, a.tablespace_name from dba_tables a, dba_tablespaces b
where a.tablespace_name = b.tablespace_name and b.encrypted = 'YES';

prompt What indexes are stored in TDE encrypted tablespaces?
select a.index_name, a.tablespace_name from dba_indexes a, dba_tablespaces b
where a.tablespace_name = b.tablespace_name and b.encrypted = 'YES' and index_name not like 'SYS_IL%';

prompt  getting key/wallet details:
SELECT * FROM v$encryption_wallet;
SELECT 
&_COMMENT con_id, key_id FROM v$encryption_keys
&_UNCOMMENT   from dual;
...
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>LOB Segments Large than 10M</b></font> 
prompt <b>Excluding all internal system schemas (i.e. CTXSYS, MDSYS, SYS, SYSTEM)</b>
...
&_COMMENT       m.owner,
&_COMMENT       m.name,
&_COMMENT       m.mview_site,
&_COMMENT       m.can_use_log,
&_COMMENT       m.updatable,
&_COMMENT       m.refresh_method,
&_COMMENT       m.version
&_COMMENT  from cdb_registered_mviews m, cdb_users u, v$containers c
&_COMMENT where m.owner = u.username
&_COMMENT   and m.con_id = u.con_id
&_COMMENT   and u.con_id = c.con_id
&_COMMENT   and u.oracle_maintained = 'N'
&_COMMENT order by 1, 3, 4
&_UNCOMMENT   from dual;
-- +----------------------------------------------------------------------------+
...
&_COMMENT       c.name container,
&_COMMENT       u.username,
&_COMMENT       u.account_status,
&_COMMENT       u.default_tablespace,
&_COMMENT       u.temporary_tablespace,
&_COMMENT       u.local_temp_tablespace,
&_COMMENT       u.profile,
&_COMMENT       u.initial_rsrc_consumer_group,
&_COMMENT       u.password_versions,
&_COMMENT       u.created,
&_COMMENT       u.lock_date,
&_COMMENT       u.expiry_date,
&_COMMENT	   u.oracle_maintained
&_COMMENT  from cdb_users u, v$containers c
&_COMMENT where u.con_id = c.con_id
&_COMMENT order by 1, 4 desc
&_UNCOMMENT   from dual;
...
&_COMMENT       c.name container,
&_COMMENT       p.profile,
&_COMMENT       p.resource_name,
&_COMMENT       p.resource_type,
&_COMMENT       p.limit
&_COMMENT  from cdb_profiles p, v$containers c
&_COMMENT where p.con_id = c.con_id
&_COMMENT order by 1,3
&_UNCOMMENT   from dual;
...
prompt  Jobs and Schedules Failed 
select 
  schema_user,
    what,
...
&_COMMENT       j.log_user,
&_COMMENT       j.what,
&_COMMENT       j.next_date,
&_COMMENT       j.interval,
&_COMMENT       j.last_date,
&_COMMENT       j.failures,
&_COMMENT       j.broken
&_COMMENT  from cdb_jobs j, v$containers c
&_COMMENT where j.con_id = c.con_id
&_COMMENT order by job
&_UNCOMMENT   from dual;
...
&_COMMENT       j.owner,
&_COMMENT       j.job_name,
&_COMMENT       j.schedule_name,
&_COMMENT       j.start_date,
&_COMMENT       j.end_date,
&_COMMENT       j.repeat_interval,
&_COMMENT       j.enabled,
&_COMMENT       j.state,
&_COMMENT       j.stop_on_window_close
&_COMMENT  from cdb_scheduler_jobs j, v$containers c
&_COMMENT where j.con_id = c.con_id
&_COMMENT order by 1, 3
&_UNCOMMENT   from dual;
...
&_COMMENT  c.con_id,
&_COMMENT       c.name container,
&_COMMENT       b.window_group_name,
&_COMMENT       a.window_name,
&_COMMENT       a.repeat_interval,
&_COMMENT       a.next_start_date,
&_COMMENT       a.duration
&_COMMENT  from cdb_scheduler_windows          a,
&_COMMENT       cdb_scheduler_wingroup_members b,
&_COMMENT       v$containers                   c
&_COMMENT where a.window_name = b.window_name
&_COMMENT   and a.con_id = b.con_id
&_COMMENT   and b.con_id = c.con_id
&_COMMENT order by 1
&_UNCOMMENT   from dual;
...
select 
&_COMMENT       c.name container,
&_COMMENT       j.client_name,
&_COMMENT       j.window_name,
&_COMMENT       j.window_start_time,
&_COMMENT       j.window_duration,
&_COMMENT       j.job_name,
&_COMMENT       j.job_status,
&_COMMENT       j.job_start_time,
&_COMMENT       j.job_duration,
&_COMMENT       j.job_error,
&_COMMENT       j.job_info
&_COMMENT  from cdb_autotask_job_history j, v$containers c
&_COMMENT where j.con_id = c.con_id
&_COMMENT and window_start_time>sysdate-3
&_COMMENT order by 1,2,job_start_time
&_UNCOMMENT   from dual;
...
host echo Check Exadata...
prompt
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b> Oracle Exadata Machine </b></font> 
prompt <a name="exa"></a>
select decode(count(*),0,'Non Exadata','Exadata'),count(*) cells from (select distinct cell_name from gv$cell_state);
...
select
 ...
 from sys.x$ksppi n, sys.x$ksppcv c
 where n.indx=c.indx
 and (    lower(n.ksppinm) || ' ' || lower(n.ksppdesc)) like lower('%exadata%');
...
col PARSING_SCHEMA_NAME for a30 heading parse_u
col sql_text for a100
SELECT *
  FROM (SELECT PARSING_SCHEMA_NAME,sql_id, child_number, sql_text, 	executions,
	fetches,
	rows_processed,
  ...
  user_io_wait_time/1000000 total_iowait_sec,
	...
	disk_reads total_pios,
          ...
          FROM v$sql
		  where PARSING_SCHEMA_NAME not in('SYS','DBSNMP','ORACLE_OCM','MDSYS','AUDSYS')
		  )
 WHERE elapsed_rank <= 20;
 
prompt Top  20 buffer gets SQL from cache
SELECT * FROM
(SELECT sql_id,substr(sql_text,1,999) sql_text,
        fetches,
	rows_processed,
  rows_processed/nullif(fetches,0) rows_per_fetch,
	ROUND(cpu_time/NULLIF(executions,0)/1000000,3)     cpu_sec_exec,
  ...
  user_io_wait_time/1000000 total_iowait_sec,
	buffer_gets total_LIOS
   FROM V$SQLAREA 
  WHERE buffer_gets > 10 AND PARSING_SCHEMA_NAME not in('SYS','DBSNMP','ORACLE_OCM','MDSYS','AUDSYS')
 ORDER BY buffer_gets DESC)
WHERE rownum <= 20
/

prompt <a name="sql_statements_with_most_disk_reads"></a>
prompt <b>Top 50 SQL statements with disk reads </b>

SELECT * FROM
(SELECT PARSING_SCHEMA_NAME,sql_id,substr(sql_text,1,999) sql_text,
        fetches,
	rows_processed,
  rows_processed/nullif(fetches,0) rows_per_fetch,
	ROUND(cpu_time/NULLIF(executions,0)/1000000,3)     cpu_sec_exec,
  ...
  user_io_wait_time/1000000 total_iowait_sec,
	disk_reads total_PIOS
   FROM V$SQLAREA 
  WHERE disk_reads > 10 AND PARSING_SCHEMA_NAME not in('SYS','DBSNMP','ORACLE_OCM','MDSYS','AUDSYS')
...
PROMPT Displaying daily top SQL for last 3 days days...
...
, sqlstat AS (
    ...
    FROM
      ...
      NATURAL JOIN
        dba_hist_sqlstat
    WHERE
        begin_interval_time > trunc(SYSDATE - 3)
    GROUP BY
...
col force_matching_signature for 99999999999999999999999999999999999999
...
select * from (
select sql_id,PARSING_SCHEMA_NAME, count(distinct plan_hash_value) cnt
  from v$sql
 group by sql_id,PARSING_SCHEMA_NAME
having count(distinct plan_hash_value) > 3
order by cnt) where rownum<50;
/
...
prompt 
prompt <a name="sysdba_user"></a>
prompt  Database USERs of SYSDBA
select * from v$pwfile_users;

prompt  SYS password expire
...
select trig.OWNER,TRIGGER_NAME,TRIGGER_TYPE,TRIGGERING_EVENT,trig.STATUS,TRIGGER_BODY,to_char(o.created,'yyyymmdd hh24:mi:ss') from dba_triggers trig,dba_objects o  where trig.trigger_name=o.object_name and trig.OWNER=o.owner and  TRIGGERING_EVENT like 'LOG%' and trigger_name<>'GSMLOGOFF';

prompt <a name="audit"></a>
prompt Current AUDIT options 
...
prompt Current Unified Auditing options (12c+)

SELECT PARAMETER,VALUE FROM V$OPTION WHERE PARAMETER = 'Unified Auditing';

select 
&_COMMENT * from audit_unified_enabled_policies
&_UNCOMMENT   from dual;
...
select owner, object_name, object_type, 
       alt,aud,com,del,gra,ind,ins,loc,ren,sel,upd,rea,exe 
from sys.dba_obj_audit_opts 
where  
   alt !='-/-' or aud !='-/-' or com !='-/-' 
or del !='-/-' or gra !='-/-' or ind !='-/-' 
or ins !='-/-' or loc !='-/-' or ren !='-/-' 
or sel !='-/-' or upd !='-/-' or rea !='-/-' or exe !='-/-' 
/ 
 
prompt Audit Trail... Note That The Query Returns The Audit Data For The Last Day Only
...
select username userid, to_char(timestamp,'yyyymmdd') timest , 
  action_name acname, priv_used, obj_name obn, ses_actions ,count(*) cnt
from sys.dba_audit_trail
where timestamp>sysdate-1
group by username,to_char(timestamp,'yyyymmdd'),action_name,priv_used,obj_name,ses_actions
/ 
prompt </div>
...
prompt  check rman backup for the last 3 days
...
from  v$rman_status where start_time>sysdate-3 order by start_time;
...
prompt <a name="beginbck"></a>
prompt  check datafiles in begin backup state
...
select 
&_COMMENT c.name container,a.dbid,a.snap_interval,a.retention,a.topnsql
&_COMMENT from cdb_hist_wr_control a, v$containers c
&_COMMENT where a.dbid = c.dbid
&_UNCOMMENT   from dual;
...
prompt <a name="dba_sql_profiles"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>SQL Profiles</b></font><hr align="left" width="460">  
col signature for 999999999999999999
SELECT p.name, p.signature, p.category, p.status,p.force_matching,ROW_NUMBER()
...
prompt <a name="dba_sql_patches"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>SQL Patches</b></font><hr align="left" width="460">  

select p.name,p.CREATED,SQL_TEXT, p.signature, p.category, row_number() 
...
select inst_id,name parameter_name,value,decode(value,'AUTO','OK','WARNING!!!') check_value from gv$parameter where upper(name) in ('STANDBY_FILE_MANAGEMENT');

select inst_id,name parameter_name,value,'IN ASM?' to_check from gv$parameter where upper(name) in ('DB_CREATE_FILE_DEST');
...
col MAXVAL for 999,999,999,999.99
col AVERAGE for 999,999,999,999.99
...
SELECT 
&_COMMENT  x.con_id, v.name  con_name, x.tablespace_name,files, x.fsm, y.apm, round(1-fsm/apm,2) pct
&_COMMENT FROM (SELECT c1.con_id, cf1.tablespace_name, SUM(cf1.bytes)/1024/1024 fsm
           FROM cdb_free_space cf1
               ,v$containers c1
           WHERE cf1.con_id = c1.con_id
           GROUP BY c1.con_id, cf1.tablespace_name)x, (SELECT c2.con_id, cd.tablespace_name, count(*) files,SUM(cd.bytes)/1024/1024 apm
           FROM cdb_data_files cd
               ,v$containers c2
           WHERE cd.con_id = c2.con_id
           GROUP BY c2.con_id
                   ,cd.tablespace_name)y, v$containers v
&_COMMENT WHERE x.con_id          = y.con_id
&_COMMENT AND   x.tablespace_name = y.tablespace_name
&_COMMENT AND   v.con_id          = y.con_id
&_COMMENT UNION
&_COMMENT SELECT vc2.con_id, vc2.name , tf.tablespace_name,count(*) files, null, SUM(tf.bytes)/1024/1024, null
&_COMMENT FROM v$containers vc2, cdb_temp_files tf
&_COMMENT WHERE vc2.con_id = tf.con_id
&_COMMENT GROUP BY vc2.con_id, vc2.name , tf.tablespace_name
&_COMMENT ORDER BY 1, 2
&_UNCOMMENT   from dual; 

PROMPT Print the details of the Users Tablespace Quotas
SELECT   
&_COMMENT con_id,tablespace_name ta, username , bytes / 1024/1024  size_mb,
&_COMMENT         max_bytes / 1024/1024 max_bytes
&_COMMENT    FROM cdb_ts_quotas
&_COMMENT   WHERE MAX_BYTES!=-1
&_COMMENT   ORDER BY tablespace_name, username
&_UNCOMMENT   from dual;
...
select 
&_COMMENT   c.name container, s.*
&_COMMENT  from v$im_segments s, v$containers c, cdb_users u
&_COMMENT where s.con_id = c.con_id
&_COMMENT   and c.con_id = u.con_id
&_COMMENT   and s.con_id = u.con_id
&_COMMENT   and u.oracle_maintained = 'N'
&_COMMENT order by 1,s.owner
&_UNCOMMENT   from dual;
...
select 
&_COMMENT c.name contianer, p.*
&_COMMENT   from cdb_lockdown_profiles p, v$containers c
&_COMMENT  where p.con_id = c.con_id
&_UNCOMMENT   from dual;
...
&_COMMENT      c.name container,
&_COMMENT       r.plan,
&_COMMENT       r.num_plan_directives,
&_COMMENT       r.cpu_method,
&_COMMENT       r.mgmt_method,
&_COMMENT       r.active_sess_pool_mth,
&_COMMENT       r.parallel_degree_limit_mth,
&_COMMENT       r.queueing_mth,
&_COMMENT       r.sub_plan,
&_COMMENT       r.comments,
&_COMMENT       r.status,
&_COMMENT       r.mandatory
&_COMMENT  from cdb_rsrc_plans r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1,2
&_UNCOMMENT   from dual;
...
&_COMMENT      c.name container,
&_COMMENT       p.plan,
&_COMMENT       p.pluggable_database,
&_COMMENT       p.profile,
&_COMMENT       p.directive_type,
&_COMMENT       p.shares,
&_COMMENT       p.utilization_limit,
&_COMMENT       p.parallel_server_limit,
&_COMMENT       p.memory_min,
&_COMMENT       p.memory_limit,
&_COMMENT       p.comments,
&_COMMENT       p.status,
&_COMMENT       p.mandatory
&_COMMENT  from cdb_cdb_rsrc_plan_directives p, v$containers c
&_COMMENT where p.con_id = c.con_id
&_COMMENT order by 1,2
&_UNCOMMENT   from dual;
...
select 
&_COMMENT  c.name container, cpu_capable, io_capable, status
&_COMMENT  from cdb_rsrc_capability r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1
&_UNCOMMENT   from dual;
...
select 
&_COMMENT  c.name container, r.name category, r.comments, r.status, r.mandatory
&_COMMENT  from cdb_rsrc_categories r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1,2
&_UNCOMMENT   from dual;
...
select 
&_COMMENT  c.name container,
&_COMMENT       r.consumer_group,
&_COMMENT       r.cpu_method,
&_COMMENT       r.mgmt_method,
&_COMMENT       r.internal_use,
&_COMMENT       r.comments,
&_COMMENT       r.category,
&_COMMENT       r.status,
&_COMMENT       r.mandatory
&_COMMENT  from cdb_rsrc_consumer_groups r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1,2
&_UNCOMMENT   from dual;
...
&_COMMENT  c.name container,
&_COMMENT       r.grantee,
&_COMMENT       r.granted_group,
&_COMMENT       r.grant_option,
&_COMMENT       r.initial_group
&_COMMENT  from cdb_rsrc_consumer_group_privs r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1
&_UNCOMMENT   from dual;
...
select 
&_COMMENT     c.name container,
&_COMMENT       r.start_time,
&_COMMENT       r.end_time,
&_COMMENT       r.max_iops,
&_COMMENT       r.max_mbps,
&_COMMENT       r.max_pmbps,
&_COMMENT       r.latency,
&_COMMENT       r.num_physical_disks
&_COMMENT  from cdb_rsrc_io_calibrate r, v$containers c
&_COMMENT where r.con_id = c.con_id
&_COMMENT order by 1
&_UNCOMMENT   from dual;
...
select 
&_COMMENT c.name container, r.grantee, r.privilege, r.admin_option
&_COMMENT   from cdb_rsrc_manager_system_privs r, v$containers c
&_COMMENT  where r.con_id = c.con_id
&_COMMENT  order by 1
&_UNCOMMENT   from dual;
prompt
...
prompt
prompt <a name="long_identifiers"></a>     
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>12c New feature Long identifiers</b></font>
prompt 12C R2 new feature: 128 bytes for identifier
select owner,table_name,length(table_name) identifiers_length from dba_tables where length(table_name)>30  union all select null,null,null from dual;

select owner,table_name,column_name,length(column_name) identifiers_length from dba_tab_columns where length(column_name)>30  union all select null,null,null,null from dual;

prompt
prompt <a name="max_string"></a>     
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>12C New Feature Max strings</b></font>
 
SELECT NAME ,DISPLAY_VALUE 
FROM V$PARAMETER 
WHERE UPPER(NAME) LIKE UPPER('%max_string_size%') 
union all
select '' ,'' from dual
/


prompt STANDARD  default, 4000 bytes for VARCHAR2 and NVARCHAR2, and 2000 bytes for RAW, EXTENDED to 32bytes


host echo Check HOST /OS STATS...
prompt <a name="OS_stat"></a>  
prompt   
host cat /etc/*release|egrep -i "PRETTY_NAME|release" >> &FileName._&_dbname._&_spool_time..html
...
host lsblk   >> &FileName._&_dbname._&_spool_time..html
ho echo '</p>'>> &FileName._&_dbname._&_spool_time..html
ho echo 
...
host netstat -in >> &FileName._&_dbname._&_spool_time..html
ho echo '</p>'>> &FileName._&_dbname._&_spool_time..html
ho echo 'Recommendation the MTU of loopback adapter to 16384 refer Doc ID 2322410.1'>> &FileName._&_dbname._&_spool_time..html
ho echo 
ho echo "</pre>" >> &FileName._&_dbname._&_spool_time..html
