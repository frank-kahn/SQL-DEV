...
create table test_t(id int,content varchar(100),col2 varchar(100));
drop sequence if exists test_s;
create sequence test_s;
insert into test_t values (nextval('test_s'),'String1/string2','test1');
insert into test_t values (nextval('test_s'),'String3/string4','test2');
select * from test_t;

 id |     content     | col2  
----+-----------------+-------
  1 | String1/string2 | test1
  2 | String3/string4 | test2
  
-- 根据/将一行拆分为多行
with tmp as (
select nextval('test_s') as id,
regexp_split_to_table(content,'/') as content,
col2
from test_t
)
insert into test_t
select id,content,col2 from tmp;
...
-- 删除/的记录
delete from test_t where content ~ '/';
~~~
