...
--Create the COUNTRIES table to hold country information for customers and company locations. 
...
/* Create the JOB_HISTORY table to hold the history of jobs that employees have held in the past.
...
--Create the EMP_DETAILS_VIEW that joins the employees, jobs, epartments, jobs, countries, and locations table to provide details about employees.
...
--
-- create procedural objects hr_code file
--
...
--
-- add comments to tables and columns hr_comnt
--
